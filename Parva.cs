...
namespace Parva {
  ...
  public class Parva {
    ...
    public static void Main (string[] args) {
      bool mergeErrors = false, execution = true, immediate = false, codEnable = false;
      ...
      for (int i = 0; i < args.Length; i++) {
		...
		else if (args[i].ToLower().Equals("-c")) codEnable = true;
      ...
      if (inputName == null) {
		...
		Console.WriteLine("-c forces the production of the .cod file")
